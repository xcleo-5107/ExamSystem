...
public class PoModuleExercise {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(exerciseNum, that.exerciseNum) && Objects.equals(moduleNum, that.moduleNum) && Objects.equals(exerciseInModuleNum, that.exerciseInModuleNum);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, exerciseNum, moduleNum, exerciseInModuleNum);
    }
}
